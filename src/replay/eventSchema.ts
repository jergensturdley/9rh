...
export type ReplayEvent =
  ...
  | { type: "step_start"; seq: number; ts: number; step: StepContext; payload: Record<string, unknown> }
  | { type: "step_end"; seq: number; ts: number; step: StepContext; payload: { stepIndex: number } }
  | LLMRequestEvent
  | LLMResponseEvent
  | ToolCallEvent
  | ToolResultEvent
