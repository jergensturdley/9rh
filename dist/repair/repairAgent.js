...
function matchPlaybook(msg, entries) {
...
function buildUserPrompt(ctx, playbookMatch) {
...
export async function runRepairAgent(ctx) {
    ...
    const messages = [
        ...
        { role: "user", content: buildUserPrompt(ctx, playbookMatch) },
    ];
    let llmResult = null;
    try {
    ...
    const autoApply = (playbookMatch?.autoApply ?? false) || llmResult.confidence === "HIGH";
...
//# sourceMappingURL=repairAgent.js.map