...
describe("postMortemLogger", () => {
    ...
    it("logIncident writes a json file per incident", async () => {
        ...
        await logIncident(errorContext, 2, "ESCALATED", 500, "Something went wrong");
