...
describe("Reasoner", () => {
    ...
    describe("plan / summarize", () => {
        it("emits a reasoning_plan event before tool execution", () => {
            ...
            expect(emitted[0].payload.callId).toBe("call_123");
            expect(emitted[0].payload.chosenTool).toBe("read_file");
        });
...
//# sourceMappingURL=reasoner.test.js.map